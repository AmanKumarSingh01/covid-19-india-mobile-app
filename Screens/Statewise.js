        ...
        <View>
                ...
                <SafeAreaView>
                  ...
                  <View style={styles.header}>
                    <Text style={styles.text}>Let's take a look on trends.</Text>
                    {/* <Text style ={styles.text}>We will win this war if we follow social distancing.</Text> */}
                    <Image source={require('./../Asserts/SiteStats.png')}  style={styles.image}/>
                </View>
                 
                <View style={{padding:'5%'}}>
                  <CardIndia data ={this.props.News.stateData}/>
                </View>
                </ScrollView>
                </SafeAreaView>
            </View>
    ...
    <View style={styles.istyle}>
      <View style={styles.india}>
        ...
        <View style={styles.Display}>
            ...
            <Text style={{marginLeft : hp(5) , color :'red'}}>Active</Text>
            <Text style={{color: 'green'}}>Cured</Text>
            <Text style={{color: 'grey'}}>Death</Text>
        </View>
        <View style = { styles.dataShow}>
            {props.data.map(news =>(
                <View style = { styles.dataShowInner}>
                    <Text style = { {width:'20%' ,color: 'grey'}}>
                       {news.state} 
                    </Text>
...
export default connect(mapStateToProps, {init , getLocation ,getDistance , getStateData , getZones , SetFetched})(Statewise)
